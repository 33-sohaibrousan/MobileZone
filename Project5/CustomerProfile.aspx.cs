...
namespace Project5
{
    public partial class CustomerProfile : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("data source=DESKTOP-7JI0FAF\\SQLEXPRESS ; database=MobileZone ; integrated security = SSPI");
            con.Open();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection connection = new SqlConnection("data source = DESKTOP-7JI0FAF\\SQLEXPRESS ; database=MobileZone;integrated security=SSPI");
            connection.Open();
